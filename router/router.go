...
func role(r *gin.Engine) {
	roleGroup := r.Group("/role", middleware.VerifyUserStatus, middleware.PermissionVerification)
...
func user(r *gin.Engine) {
	userGroup := r.Group("/user", middleware.VerifyUserStatus, middleware.PermissionVerification)
...
func topic(r *gin.Engine) {
	topicGroup := r.Group("/topic", middleware.VerifyUserStatus)
